...
emilie = User.create(first_name: "Émilie", last_name: "Hachette", country: "France",email: "emilie@achette.com", password: "password", description: 'Hi guys, my name is Émilie and I come from Franch. I have been speaking English for many years but I would like to improve. I really look forward to speaking with someone!')
