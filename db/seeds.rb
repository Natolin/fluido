...
syd = User.create(first_name: "Syd", last_name: "Thomas", country: "UsaBitch",email: "s@s.com", password: "ssssss", description: '', average_rating: 4.2, photo: "babe.jpeg")
jess = User.create(first_name: "Jesse", last_name: "Davis", country: "UsaDude",email: "j@j.com", password: "jjjjjj", description: '', average_rating: 5, photo: "gator.jpeg")
...
Booking.create(start_date: "2018-02-03 01:00:00 UTC", end_date: "2018-02-03 05:30:00 UTC", user_id: syd.id, lesson_id: portuguese_lesson.id)
Booking.create(start_date: "2018-02-03 01:00:00 UTC", end_date: "2018-04-03 05:30:00 UTC", user_id: chris.id, lesson_id: polish_lesson.id)
Booking.create(start_date: "2018-02-03 01:00:00 UTC", end_date: "2018-06-03 05:30:00 UTC", user_id: jess.id, lesson_id: german_lesson.id)
Booking.create(start_date: "2018-02-03 01:00:00 UTC", end_date: "2018-06-03 05:30:00 UTC", user_id: pit.id, lesson_id: russian_lesson.id)
...
Booking.create(start_date: "2018-02-02 01:00:00 UTC", end_date: "2018-02-02 02:00:00 UTC", user_id: jess.id, lesson_id: french_lesson.id, rating: 3)
Booking.create(start_date: "2018-02-03 01:00:00 UTC", end_date: "2018-02-03 05:30:00 UTC", user_id: syd.id, lesson_id: italian_lesson.id, rating: 5)
